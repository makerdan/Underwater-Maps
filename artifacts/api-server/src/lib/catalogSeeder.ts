...
export const EXTRA_CATALOG_ENTRIES: CatalogSeedEntry[] = [
  ...
  },
  {
    ...
    resolutionMMin: 30,
    resolutionMMax: 90,
    coverageBbox: { minLon: -84.8, minLat: 43.0, maxLon: -79.7, maxLat: 46.5 },
    endpointUrl: "https://gis.ngdc.noaa.gov/arcgis/services/DEM_mosaics/NOAA_Great_Lakes_mosaics/ImageServer/WCSServer",
  ...
  },
  {
    ...
    resolutionMMin: 30,
    resolutionMMax: 90,
    coverageBbox: { minLon: -83.5, minLat: 41.3, maxLon: -78.9, maxLat: 42.9 },
    endpointUrl: "https://gis.ngdc.noaa.gov/arcgis/services/DEM_mosaics/NOAA_Great_Lakes_mosaics/ImageServer/WCSServer",
  ...
  },
  {
    ...
    resolutionMMin: 30,
    resolutionMMax: 90,
    coverageBbox: { minLon: -79.9, minLat: 43.1, maxLon: -76.0, maxLat: 44.3 },
    endpointUrl: "https://gis.ngdc.noaa.gov/arcgis/services/DEM_mosaics/NOAA_Great_Lakes_mosaics/ImageServer/WCSServer",
