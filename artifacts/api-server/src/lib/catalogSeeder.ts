...
export const EXTRA_CATALOG_ENTRIES: CatalogSeedEntry[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    endpointUrl:
      "https://gis.ngdc.noaa.gov/arcgis/services/DEM_mosaics/DEM_all/ImageServer/WCSServer",
    accessNotes:
      ...
      "WCS coverage identifier: DEM_all. The dedicated CRM 703 service was deleted upstream; DEM_mosaics/DEM_all (best-available tiled DEM mosaic) still includes the CRM 703 grids. NCEI geoportal metadata: gov.noaa.ngdc.mgg.dem:703.",
    description:
  ...
  // -------------------------------------------------------------------------
  {
    ...
    endpointUrl: "https://enterprise.gisdata.mn.gov/aghost/rest/services/us_mn_state_dnr/water_lake_bathymetry/MapServer/0",
    accessNotes:
      "MN DNR Lake Bathymetric Contours ArcGIS REST layer (lowercase `depth` attribute in FEET, negative down). " +
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    endpointUrl: "https://gis.ngdc.noaa.gov/arcgis/services/DEM_mosaics/DEM_global_mosaic/ImageServer/WCSServer",
    accessNotes: "WCS coverage: DEM_global_mosaic. The dedicated NOAA Great Lakes per-lake mosaic service was deleted upstream; the NCEI global DEM mosaic carries the same lake bathymetry.",
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    accessNotes: "No public machine-readable bathymetry service exists for Lake George (the NYSDEC statewide service was deleted upstream and its Finger Lakes successor has no Lake George coverage; the DEC sonar contour map is PDF-only). Jefferson Project (RPI/IBM) multibeam survey investigated 2026-07-21: the ~0.5 m Substructure Inc. survey was never publicly released — the public Data Dashboard (jeffersonproject.live) exposes only sensor/weather/water-quality data; EDI hosts only Jefferson Project water-quality/hydrology packages; DataONE, HydroShare, ScienceBase, NYS Geographic Information Gateway (DOS), ArcGIS Online/Hub, and NOAA NCEI (no multibeam surveys or lake DEMs intersect the bbox; only global ETOPO/CRM) all have no Lake George bathymetry; NYSFOLA Atlas offers PDF contour maps only. Access would require a data request to the Jefferson Project/DFWI. USGS 3DEP ImageServer (exportImage REST) topobathy fallback.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream) as primary source. High-resolution NYSDEC/VT DEC bathymetric survey also available via state GIS portals.",
  ...
  },
  {
    ...
    endpointUrl: "https://data.gis.ny.gov/datasets/bff954401b5641a2a920482532b7a0ae_0/about",
    accessNotes: "NYSDEC \"Bathymetry of the Finger Lakes\" ArcGIS Feature Service (successor to the deleted statewide DEC_Lake_Bathymetry service). Depth polygons with a DEPTH attribute in FEET.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "The NYSDEC statewide bathymetry service was deleted upstream and its Finger Lakes successor does not cover this lake; USGS 3DEP ImageServer (exportImage REST) topobathy is the best available public source.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). NH DES bathymetric survey also available via GRANIT GIS portal.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). Maine DEP bathymetric survey available via Maine GeoLibrary.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). Maine's largest lake.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). Massachusetts DCR manages access; fishing by permit.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). Transboundary lake — US portion in Vermont; majority in Quebec, Canada.",
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    endpointUrl: "https://enterprise.gisdata.mn.gov/aghost/rest/services/us_mn_state_dnr/water_lake_bathymetry/MapServer/0",
    accessNotes: "MN DNR Lake Bathymetric Contours ArcGIS REST layer (lowercase `depth` attribute in FEET, negative down); bathymetric contours available via MN DNR LakeFinder.",
  ...
  },
  {
    ...
    endpointUrl: "https://enterprise.gisdata.mn.gov/aghost/rest/services/us_mn_state_dnr/water_lake_bathymetry/MapServer/0",
    accessNotes: "MN DNR Lake Bathymetric Contours ArcGIS REST layer (lowercase `depth` attribute in FEET, negative down).",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). Wisconsin DNR bathymetric survey also available.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). Michigan DNR bathymetric chart also available.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). Largest natural freshwater lake in the western US.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). Created by Shasta Dam (USBR); largest reservoir in California by capacity.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). Third-deepest lake in the US.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). Largest lake in Oregon; critical habitat for C. coho salmon and Lost River suckers.",
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). USACE operates the Herbert Hoover Dike surrounding the lake for flood control.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). USACE South Atlantic Division manages Buford Dam on the Chattahoochee River.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). Created by Bagnell Dam (AmerenUE) on the Osage River.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). USACE Little Rock District manages Table Rock Dam on the White River.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). TVA's first completed dam (Norris Dam, 1936) on the Clinch River.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). TVA Fontana Dam (highest in eastern US) on the Little Tennessee River. Borders Great Smoky Mountains National Park.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). AEP Smith Mountain Dam on the Roanoke (Staunton) River.",
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). LCRA-operated; part of the Highland Lakes chain on the Colorado River (Texas).",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). USACE Fort Worth District; Canyon Dam on the Guadalupe River.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). LCRA-operated; Wirtz Dam creates Lake LBJ on the Colorado River (Texas).",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). LCRA-operated; Inks Dam on the Colorado River (Texas). Adjacent to Inks Lake State Park.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). LCRA-operated; Buchanan Dam (Texas's largest multi-arch dam) on the Colorado River.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). USBR Elephant Butte Dam on the Rio Grande; water levels vary substantially.",
  ...
  },
  {
    ...
    endpointUrl: "https://elevation.nationalmap.gov/arcgis/rest/services/3DEPElevation/ImageServer",
    accessNotes: "USGS 3DEP ImageServer (exportImage REST; the 3DEP WCSServer endpoint was retired upstream). USACE Albuquerque District; Cochiti Dam on the Rio Grande — one of the largest earthen dams in the US.",
