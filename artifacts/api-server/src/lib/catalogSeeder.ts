...
export const EXTRA_CATALOG_ENTRIES: CatalogSeedEntry[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    accessNotes: "No public machine-readable bathymetry service exists for Lake George (the NYSDEC statewide service was deleted upstream and its Finger Lakes successor has no Lake George coverage; the DEC sonar contour map is PDF-only). USGS 3DEP ImageServer (exportImage REST) topobathy fallback.",
