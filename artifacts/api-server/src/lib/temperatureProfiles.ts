...
export const bundledCasts: BundledCast[] = [
  ...
  {
    // Sitka Sound — outer coast shelf, Gulf of Alaska.
    datasetId: "sitka-sound",
    lat: 57.05,
    lon: -135.45,
    samples: [
      { depthM: 0, temperatureC: 12.8 },
      { depthM: 10, temperatureC: 12.3 },
      { depthM: 20, temperatureC: 10.9 },
      { depthM: 30, temperatureC: 9.1 },
      { depthM: 50, temperatureC: 7.8 },
      { depthM: 75, temperatureC: 6.9 },
      { depthM: 100, temperatureC: 6.3 },
      { depthM: 150, temperatureC: 5.7 },
      { depthM: 200, temperatureC: 5.2 },
      { depthM: 250, temperatureC: 4.9 },
    ],
    source: `${WOA_SOURCE} — Sitka Sound`,
    sourceUrl: WOA_URL,
    timestamp: WOA_TIMESTAMP,
    provider: "bundled-woa",
  },
  {
    // Juneau — Gastineau Channel / Lynn Canal approach.
    datasetId: "juneau",
    lat: 58.30,
    lon: -134.40,
    samples: [
      { depthM: 0, temperatureC: 12.1 },
      { depthM: 10, temperatureC: 11.6 },
      { depthM: 20, temperatureC: 10.2 },
      { depthM: 30, temperatureC: 8.6 },
      { depthM: 50, temperatureC: 7.4 },
      { depthM: 75, temperatureC: 6.6 },
      { depthM: 100, temperatureC: 6.1 },
      { depthM: 150, temperatureC: 5.5 },
      { depthM: 200, temperatureC: 5.0 },
      { depthM: 250, temperatureC: 4.7 },
    ],
    source: `${WOA_SOURCE} — Juneau`,
    sourceUrl: WOA_URL,
    timestamp: WOA_TIMESTAMP,
    provider: "bundled-woa",
  },
  {
    // Glacier Bay — tidewater-glacier fjord, northern panhandle.
    datasetId: "glacier-bay",
    lat: 58.65,
    lon: -136.05,
    samples: [
      { depthM: 0, temperatureC: 10.4 },
      { depthM: 10, temperatureC: 9.9 },
      { depthM: 20, temperatureC: 8.7 },
      { depthM: 30, temperatureC: 7.5 },
      { depthM: 50, temperatureC: 6.5 },
      { depthM: 75, temperatureC: 5.8 },
      { depthM: 100, temperatureC: 5.3 },
      { depthM: 150, temperatureC: 4.8 },
      { depthM: 200, temperatureC: 4.4 },
      { depthM: 250, temperatureC: 4.1 },
    ],
    source: `${WOA_SOURCE} — Glacier Bay`,
    sourceUrl: WOA_URL,
    timestamp: WOA_TIMESTAMP,
    provider: "bundled-woa",
  },
  {
    // Ketchikan — Revillagigedo Channel / southern panhandle.
    datasetId: "ketchikan",
    lat: 55.35,
    lon: -131.65,
    samples: [
      { depthM: 0, temperatureC: 13.5 },
      { depthM: 10, temperatureC: 13.1 },
      { depthM: 20, temperatureC: 11.7 },
      { depthM: 30, temperatureC: 10.0 },
      { depthM: 50, temperatureC: 8.4 },
      { depthM: 75, temperatureC: 7.4 },
      { depthM: 100, temperatureC: 6.8 },
      { depthM: 150, temperatureC: 6.1 },
      { depthM: 200, temperatureC: 5.6 },
      { depthM: 250, temperatureC: 5.2 },
    ],
    source: `${WOA_SOURCE} — Ketchikan`,
    sourceUrl: WOA_URL,
    timestamp: WOA_TIMESTAMP,
    provider: "bundled-woa",
  },
