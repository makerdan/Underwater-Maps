...
After upload the app builds a terrain mesh, runs zone classification, and saves it. Your new dataset appears automatically under **My Datasets** — no manual save step is required. Click it to load it immediately.
