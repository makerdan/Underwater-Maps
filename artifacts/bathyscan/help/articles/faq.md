...
Pressing **Q** (or right-clicking the terrain) opens the **Crosshair Action Menu** at the current terrain point. It contains: Drop GPS pin, Measure, Depth Profile, Set as home position, Save view as bookmark, Copy coordinates, and Copy share link.

## How do I see weather at a location?

Click **🛩 NOAA WEATHER STATIONS** or **🌿 RAWS WEATHER STATIONS** in the Overlays panel (left sidebar) to show weather station pins. Click any pin for a popover showing wind, visibility, ceiling, temperature, and observation time. See [Weather Stations](#article:weather-stations) for details.

## How do I open the overview map?

Press **O**, or click **🗺 OVERVIEW** in the Overlays panel (left sidebar). See [Overview Map](#article:overview-map) for details.
