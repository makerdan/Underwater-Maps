...
const StarRating: React.FC<{ stars: 1 | 2 | 3 }> = ({ stars }) => (
  <span aria-label={`${stars} out of 3 stars`} style={{ letterSpacing: 1 }}>
    {[1, 2, 3].map((n) => (
      <span
        key={n}
        style={{ color: n <= stars ? "#fb923c" : "rgba(251,146,60,0.22)", fontSize: "calc(16.5px * var(--bs-font-scale, 1))" }}
      >
        ★
      </span>
    ))}
  ...
  <ViewscreenTooltip label="Snap tidal scrubber to this window" side="right">
    ...
    >
      <div className="flex items-center justify-between" style={{ marginBottom: 2 }}>
        <span style={{ color: "#fb923c", fontSize: "calc(15px * var(--bs-font-scale, 1))", fontWeight: 600 }}>
      ...
      <div style={{ color: "#cbd5e1", fontSize: "calc(13.5px * var(--bs-font-scale, 1))", letterSpacing: "0.06em" }}>
        {w.phaseLabel}
      </div>
    </button>
  </ViewscreenTooltip>
  ...
  >
    <div className="flex items-start justify-between gap-1">
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ color: "#f1f5f9", fontSize: "calc(16.5px * var(--bs-font-scale, 1))", marginBottom: 1 }}>
          <span style={{ color: "#cbd5e1", fontSize: "calc(15px * var(--bs-font-scale, 1))" }}>#{index + 1} </span>
          <span style={{ color: "#fb923c", fontWeight: 600 }}>{Math.round(hotspot.score * 100)}%</span>
          <span style={{ color: "#e2e8f0", fontSize: "calc(15px * var(--bs-font-scale, 1))" }}> match</span>
        </div>
        <ScoreBar score={hotspot.score} />
        <div style={{ fontSize: "calc(15px * var(--bs-font-scale, 1))", color: "#cbd5e1", marginTop: 3 }}>
    ...
    <div style={embedded ? { width: "100%" } : PANEL} className="habitat-panel">
      ...
      >
        <span
          ...
          style={{ fontSize: "calc(16.5px * var(--bs-font-scale, 1))", ...AMBER, fontWeight: 700 }}
        >
          ◈ Habitat Layer
        </span>
        <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <HelpIcon articleId="ai-assistant" label="Habitat layer" />
          <span style={{ fontSize: "calc(33px * var(--bs-font-scale, 1))", lineHeight: 1, color: "#cbd5e1" }}>
            {collapsed ? "▶" : "▼"}
          </span>
        </span>
      </button>
      ...
      {!collapsed && (
        <div className="px-3 py-2">
          ...
          <div style={{ marginBottom: 8 }}>
            <div style={{ fontSize: "calc(15px * var(--bs-font-scale, 1))", color: "#cbd5e1", letterSpacing: "0.08em", marginBottom: 4 }}>
          ...
          {/* Status */}
          {showOverlay && (
            <div style={{ fontSize: "calc(15px * var(--bs-font-scale, 1))", color: "#cbd5e1", marginBottom: 6, letterSpacing: "0.04em" }}>
          ...
          {showOverlay && (
            <div className="hotspot-list">
              {hotspots.length === 0 ? (
                <div style={{ fontSize: "calc(16.5px * var(--bs-font-scale, 1))", color: "#e2e8f0" }}>
                ...
                return (
                  <div key={day.dayOffset} style={{ marginBottom: 6 }}>
                    ...
                    >
                      ...
                      <span style={{ fontSize: "calc(13.5px * var(--bs-font-scale, 1))", opacity: 0.7 }}>
          ...
          {!activeSpecies && (
            <div style={{ fontSize: "calc(16.5px * var(--bs-font-scale, 1))", color: "#64748b", letterSpacing: "0.05em" }}>
