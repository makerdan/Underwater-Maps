    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 9, letterSpacing: "0.2em", color: "#00e5ff", textTransform: "uppercase", marginBottom: 2 }}>
              ⬇ SAVE OFFLINE
            </div>
            <div style={{ fontSize: 12, color: "#e2e8f0", fontWeight: 600 }}>{dataset.name}</div>
            {dataset.bbox && (
              ...
              {alreadySaved && existingPack && (
                <div style={{
                  ...
                  <div>
                    ...
                    {expLabel && (
                      <div style={{ color: expLabel.amber ? "#fbbf24" : "#4ade80", marginTop: 2, fontSize: 9 }}>
                ...
                <>
                  <div style={{ marginBottom: 8 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
                      ...
                      <span style={{ fontSize: 10, color: "#00e5ff" }}>{days} days</span>
                    </div>
                    <input
                      type="range"
                      min={3}
                    ...
                    return (
                      <div key={step} style={{
                        ...
                        <span style={{ color: isPending ? "#475569" : isErr ? "#fca5a5" : isDone ? "#4ade80" : "#e2e8f0" }}>
                          {STEP_LABELS[step]}
                          {isErr && <span style={{ fontSize: 9, marginLeft: 6, color: "#fca5a5" }}>— {prog.error}</span>}
                        </span>
                      </div>
                    );
                  })}
