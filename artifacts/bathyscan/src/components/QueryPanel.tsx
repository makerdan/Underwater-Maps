  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
        <span style={{ fontSize: "calc(15px * var(--bs-font-scale, 1))", letterSpacing: "0.22em", color: "#00e5ff", opacity: 0.85, display: "flex", alignItems: "center" }}>
        ...
        <ViewscreenTooltip label="Close query panel (Esc)" side="left">
          <button
            onClick={onClose}
            style={{ fontSize: "calc(16.5px * var(--bs-font-scale, 1))", color: "#94a3b8", cursor: "pointer", background: "none", border: "none", letterSpacing: "0.1em" }}
      ...
      {history.length > 0 && (
        <div>
          <div style={{ fontSize: "calc(13.5px * var(--bs-font-scale, 1))", color: "#64748b", letterSpacing: "0.2em", marginBottom: 5 }}>
            RECENT
          </div>
