    ...
    <>
      <div data-testid="routes-panel" style={PANEL_STYLE}>
        <div style={{ display: "flex", alignItems: "center", paddingRight: 6 }}>
          ...
          >
            <span style={{ fontSize: "calc(16.5px * var(--bs-font-scale, 1))", letterSpacing: "0.2em", textTransform: "uppercase", color: "#00e5ff", textShadow: "0 0 6px rgba(0,229,255,0.5)", fontWeight: 700 }}>
              🛤 Routes {routeList.length > 0 ? `(${routeList.length})` : ""}
            </span>
            <span style={{ color: "#cbd5e1", fontSize: "calc(33px * var(--bs-font-scale, 1))", lineHeight: 1 }}>
              {collapsed ? "▸" : "▾"}
            </span>
          </button>
        ...
        {!collapsed && (
          <div style={{ padding: "6px 10px 10px" }}>
            {!isSignedIn ? (
              ...
              <div data-testid="routes-panel-synthetic-msg" style={{ fontSize: "calc(15px * var(--bs-font-scale, 1))", color: "#94a3b8" }}>
                Routes are not available for simulated data. Load a real dataset to save and view routes.
              </div>
            ) : isLoading ? (
              <div style={{ fontSize: "calc(15px * var(--bs-font-scale, 1))", color: "#94a3b8" }}>Loading…</div>
            ) : routeList.length === 0 ? (
              <div style={{ fontSize: "calc(15px * var(--bs-font-scale, 1))", color: "#94a3b8" }}>
                  ...
                  return (
                    ...
                    >
                      {editingId === route.id ? (
                        ...
                        <div
                          style={{ fontSize: "calc(16.5px * var(--bs-font-scale, 1))", color: "#e2e8f0", marginBottom: 3, cursor: "pointer", wordBreak: "break-word" }}
