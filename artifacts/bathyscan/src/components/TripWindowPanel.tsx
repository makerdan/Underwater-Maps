...
export const TripWindowPanel: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{ fontFamily: mono, fontSize: "calc(14px * var(--bs-font-scale, 1))", color: "#e2e8f0", padding: "6px 10px 8px" }}
    >
      {/* Boat-size preset selector */}
      <div style={{ marginBottom: 8 }}>
        <div style={{ fontSize: "calc(12px * var(--bs-font-scale, 1))", color: "#64748b", letterSpacing: "0.12em", marginBottom: 4 }}>
          BOAT SIZE
        </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
        <span style={{ fontSize: "calc(12px * var(--bs-font-scale, 1))", color: "#64748b", letterSpacing: "0.12em" }}>
          TRIP LENGTH
        </span>
      ...
      {loading && !windows.length ? (
        <div style={{ color: "#94a3b8", fontSize: "calc(14px * var(--bs-font-scale, 1))" }}>Loading forecast…</div>
      ) : !windows.length ? (
        <div style={{ color: "#94a3b8", fontSize: "calc(14px * var(--bs-font-scale, 1))" }}>No forecast data available</div>
      ) : (
        <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
          {windows.map((w, i) => {
            ...
            return (
              ...
              >
                ...
                <span style={{ fontSize: "calc(13.5px * var(--bs-font-scale, 1))", color: "#e2e8f0" }}>
                  {formatTripRange(w)}
                </span>
          ...
          <div style={{ fontSize: "calc(12px * var(--bs-font-scale, 1))", color: "#475569", textAlign: "right" }}>
