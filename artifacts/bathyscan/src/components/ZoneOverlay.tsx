    ...
    <div style={embedded ? { width: "100%" } : PANEL}>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          {loading && (
            <span className="animate-spin" style={{ fontSize: "calc(15px * var(--bs-font-scale, 1))", color: "#00e5ff" }}>
              ◌
            </span>
          )}
          ...
          <span style={{ fontSize: "calc(36px * var(--bs-font-scale, 1))", lineHeight: 1, color: "#cbd5e1" }}>{collapsed ? "▸" : "▾"}</span>
        </div>
      </button>
      )}
      ...
      <div className="px-3 py-2">
        ...
        {!loading && error && (
          <div
            ...
            style={{ fontSize: "calc(16.5px * var(--bs-font-scale, 1))", color: "#fca5a5", marginBottom: 6, lineHeight: 1.4, userSelect: "text" }}
          >
            {error.reason}
          </div>
        )}
              ...
              (name, slotIndex) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {visible && (
                        <span style={{ fontSize: "calc(12px * var(--bs-font-scale, 1))", color: "#00e5ff", lineHeight: 1 }}>✓</span>
                      )}
                    </button>
        ...
        {hasZoneMap && !loading && overlayEnabled && (
          ...
          >
            ...
            {paintMode && (
              <>
                <div style={{ fontSize: "calc(15px * var(--bs-font-scale, 1))", color: "#cbd5e1", letterSpacing: "0.05em" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <span style={{ fontSize: "calc(15px * var(--bs-font-scale, 1))", color: "#94a3b8", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                      Brush size
                    </span>
                    <span
                      data-testid="zone-brush-radius-value"
                      style={{ fontSize: "calc(15px * var(--bs-font-scale, 1))", color: "#00e5ff", fontVariantNumeric: "tabular-nums", minWidth: 18, textAlign: "right" }}
                    >
                      {brushRadius}
                    </span>
                  </div>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <span style={{ fontSize: "calc(13.5px * var(--bs-font-scale, 1))", color: "#475569" }}>Fine</span>
                    <span style={{ fontSize: "calc(13.5px * var(--bs-font-scale, 1))", color: "#475569" }}>Broad</span>
                  </div>
                </div>
              </>
            )}
        ...
        {!hasZoneMap && !loading && !error && (
          <div style={{ fontSize: "calc(16.5px * var(--bs-font-scale, 1))", color: "#e2e8f0", letterSpacing: "0.05em" }}>
