...
// ---------------------------------------------------------------------------
// NonPrimaryDatasetMeshes and computeLatCorrectedLonScale live in their own
// module so they can be unit-tested without pulling in TourScene's heavy R3F
// and Three.js dependencies.
// ---------------------------------------------------------------------------
import {
  NonPrimaryDatasetMeshes,
  computeLatCorrectedLonScale as _computeLatCorrectedLonScale,
} from "@/components/NonPrimaryDatasetMeshes";

/**
 * Re-exported for backwards compatibility with existing tests that import
 * computeLatCorrectedLonScale from "@/pages/TourScene".
 */
export { _computeLatCorrectedLonScale as computeLatCorrectedLonScale };
    ...
    <>
      ...
      {terrain && (
        <NonPrimaryDatasetMeshes
          ...
          TidalContents={TidalSceneContents}
        />
      )}
      <EfhZoneLayer />
      <SubstrateLayer />
