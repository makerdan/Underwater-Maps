...
export const UserSettingsVisibleMarkerTypesItem = {
  ...
  silver_salmon: 'silver_salmon',
  chinook_salmon: 'chinook_salmon',
  pink_salmon: 'pink_salmon',
  turbot: 'turbot',
  black_rockfish: 'black_rockfish',
  yelloweye_rockfish: 'yelloweye_rockfish',
  dog_shark: 'dog_shark',
  dungeness_crab: 'dungeness_crab',
  prawn_shrimp: 'prawn_shrimp',
  school_salmon: 'school_salmon',
  school_rockfish: 'school_rockfish',
  lingcod: 'lingcod',
  sole: 'sole',
  ...
  rock: 'rock',
  clam: 'clam',
  clam_beach: 'clam_beach',
  cool_rocks: 'cool_rocks',
  rock_beach: 'rock_beach',
  brushpile: 'brushpile',
  anchorage: 'anchorage',
  hazard_rock: 'hazard_rock',
  marina: 'marina',
  boat_ramp: 'boat_ramp',
  fuel_dock: 'fuel_dock',
  diver_down: 'diver_down',
  no_anchor: 'no_anchor',
...
export interface UserSettings {
  ...
  /**
     * Per-band hex colours for the Ocean/Custom depth palette. Variable length (2-16 bands), one entry per depth band. Must always be exactly one entry shorter than bandBoundaries. Persisted server-side so the palette is consistent across devices.
     * @minItems 2
     * @maxItems 16
     */
  bandColors?: string[];
  /**
     * Depth band boundaries in feet. Variable length (bandColors.length + 1 entries, 3-17), strictly increasing integers, first must be 0. Every other value including the last is user-editable up to 36000 ft. Persisted server-side so customised boundaries survive across devices.
     * @minItems 3
     * @maxItems 17
     */
  bandBoundaries?: number[];
