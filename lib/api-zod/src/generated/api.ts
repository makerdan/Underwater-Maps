...
export const GetSettingsResponse = zod.object({
  ...
  "visibleMarkerTypes": zod.array(zod.enum(['fish', 'shipwreck', 'coral', 'vent', 'custom', 'log', 'vegetation', 'sample', 'bass', 'trout', 'pike', 'walleye', 'crayfish'])).default([`fish`, `shipwreck`, `coral`, `vent`, `custom`]),
