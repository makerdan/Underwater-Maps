...
export const GetDatasetsIdTerrainResponse = zod.object({
  ...
  "width": zod.number(),
  "height": zod.number(),
  "depths": zod.array(zod.number().nullable()).describe('Row-major flat array of depth values (metres, positive = below surface). Null entries represent unfilled cells (survey gaps).'),
  "minDepth": zod.number(),
  "maxDepth": zod.number(),
  "minLon": zod.number(),
  "maxLon": zod.number(),
