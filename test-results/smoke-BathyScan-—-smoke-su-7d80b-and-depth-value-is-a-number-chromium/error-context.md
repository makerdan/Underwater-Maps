...
Expected pattern: /▼\s*[\d,]+\s*M/
Received string:  "
    Deep Sea ExplorerBATHYSCANExplore 3D bathymetric seafloor maps. Upload sonar data, drop markers, and dive in.Sign In to ExploreCreate account·········
"
```
